# Operator Quickstart — Manufacture of Cement, Lime and Plaster

Shortest path from clone to a verified local dry-run for **ISIC 2394** (`cloud-itonami-isic-2394`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2394.git
cd cloud-itonami-isic-2394
```
...
- Blueprint governor key: `kiln-governor`
- Likely source path: `cementmill.governor.cljc`
