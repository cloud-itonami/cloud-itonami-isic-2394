...
`cloud-itonami-isic-2394` is an OSS open-business blueprint for community cement, lime and plaster manufacturing (finish-mill/kiln operation), robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Kiln Governor remains independent of the advisor.
- hard policy violations (force-ship, record-suppression, unauthorized disclosure) cannot be overridden by human approval.
- every shipment, certificate-issuance, sign-off and disclose path is auditable.
